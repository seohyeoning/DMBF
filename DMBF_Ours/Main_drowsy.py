...
def Experiment(args):
    ...
    num_fold = 4
    include_sbj = [1,5,6,7,8,9,10,12,13,15,16,18,20,21,24,25,26,28,29,30,31] # drowsy 0인 sbj는 삭제
    for subj in range(1,32): # 2cl_5: (1,24)
...
if __name__ == "__main__":   
    ...
    ###################################### FIX 
    parser.add_argument('--backbone', default='EEGNet4', choices = ['EEGNet4', 'DeepConvNet', 'Transformer', 'ResNet18'])
    ...
    parser.add_argument('--freq_time', default=600, help='frequency(200)*time window(3)')

    ########## 클래스 및 채널 수 지정
    parser.add_argument('--n_channels', default=32)
    parser.add_argument('--n_classes', default=2)
    parser.add_argument('--in_dim', default=[32,1,1], choices=[[32], [32,1,1]])
    parser.add_argument('--mode', default = 'multi')
    parser.add_argument('--modal', default='ALL', choices=['ALL','EEG', 'ECG', 'PPG'])
