...
if __name__ == "__main__":   
    ...
    parser = argparse.ArgumentParser(description='Ablation_for LG dataset')

    parser.add_argument("--SEED", default=42)

    ### data_type 과 model_type 선택 필수
    parser.add_argument('--data_type', default='Stress', choices=['Distraction', 'Drowsy', 'Stress'])
    parser.add_argument('--model_type', default='DMBF_wo_CRL', choices=['DMBF_wo_CRL', 'DMBF_wo_STAM', 'DMBF_wo_GATE']) # DMBF_wo_GATE_STAM는 concat으로 대체
