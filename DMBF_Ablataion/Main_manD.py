...
def Experiment(args):
    ...
    for subj in range(1,51): # 2cl_5: (1,24)
        ...
        for nf in range(1, num_fold+1):
            ...
            print(f'Loaded data from --> {DATASET_DIR}/S{sbj}/{nf}fold')
...
if __name__ == "__main__":   
    ...
    parser = argparse.ArgumentParser(description='Ablation_manD')
    ...
    ###################################### FIX 
    parser.add_argument('--CRL_user', default=True, choices=[True, False]) # default = True, 아래에서 자동으로 변경됨 
