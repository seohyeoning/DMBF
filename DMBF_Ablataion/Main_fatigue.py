...
if __name__ == "__main__":   
    ...
    parser.add_argument('--data_type', default='Pilot_Fatigue')
    parser.add_argument('--model_type', default='DMBF_wo_STAM', choices=['DMBF_wo_CRL', 'DMBF_wo_STAM', 'DMBF_wo_GATE']) # DMBF_wo_GATE_STAM는 concat으로 대체
    ...
    parser.add_argument('--in_dim', default=[64,1,1,1], choices=[[64], [64,1], [64,1,1,1]])
